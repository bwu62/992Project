...
<li class="fragment fade-up" data-fragment-index="1">Try: encourage larger, more balanced clusters</li>
<li class="fragment fade-up" data-fragment-index="2">Methods to try:
  <ul>
  <li class="fragment fade-up" data-fragment-index="2">Transform (projected) adjacency matrix $AA^\text{T}$?</li>
  <li class="fragment fade-up" data-fragment-index="3">Contract highly connected nodes?</li>
