...
<li class="fragment fade-up" data-fragment-index="1">Methods to try:
  <ul>
  <li class="fragment fade-up" data-fragment-index="1">Transform (projected) adjacency matrix $AA^\text{T}$?</li>
  <li class="fragment fade-up" data-fragment-index="2">Contract highly connected nodes?</li>
  <li class="fragment fade-up" data-fragment-index="3">Something else??</li>
  </ul>
</li>
</ul>
